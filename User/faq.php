...
<div class="body-wrapper">
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-60 bg-image" data-bg="img/background/br_PSDA.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Pertanyaan yang Sering Diajukan</h1>
                        </div>
                    ...
                    <div id="accordion_2">
                        ...
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-1" aria-expanded="false">
                                Bagaimana cara membeli produk dari PT. Maulana Raya Abadi?
                            </h6>
                            <div id="faq-item-2-1" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>Untuk membeli produk dari PT. Maulana Raya Abadi, Anda dapat menghubungi tim sales atau perwakilan resmi kami melalui kontak yang tersedia di website atau media sosial kami. Kami juga menawarkan bimbingan lengkap mulai dari pengenalan produk hingga proses pemesanan dan pengiriman.</p>
                                </div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                            <h6 class="ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-2" aria-expanded="true"> 
                                Apakah saya bisa melakukan pengembalian atau refund produk?
                            </h6>
                            <div id="faq-item-2-2" class="collapse show" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>Kami menerima pengembalian dan refund sesuai dengan syarat dan ketentuan yang berlaku. Silakan hubungi tim layanan pelanggan kami untuk informasi lebih lanjut tentang prosedur pengembalian produk.</p>
                                </div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-3" aria-expanded="false">
                                Bagaimana cara memulai jika saya adalah pengguna baru?
                            </h6>
                            <div id="faq-item-2-3" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>Jika Anda adalah pengguna baru, Anda bisa memulai dengan menghubungi kami melalui email, telepon, atau media sosial kami. Kami akan membantu Anda mengenal lebih jauh produk-produk pupuk non-subsidi yang kami tawarkan dan proses pemesanannya.</p>
                                </div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-4" aria-expanded="false">
                                Bagaimana kebijakan pengembalian dan pengembalian dana (refund)?
                            </h6>
                            <div id="faq-item-2-4" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>PT. Maulana Raya Abadi memiliki kebijakan pengembalian dan pengembalian dana untuk produk yang tidak sesuai dengan spesifikasi. Anda dapat mengajukan klaim dengan menghubungi layanan pelanggan kami untuk prosedur lebih lanjut.</p>
                                </div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-6" aria-expanded="false">
                                Apa yang harus saya lakukan jika kode promo atau diskon tidak berfungsi?
                            </h6>
                            <div id="faq-item-2-6" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>Jika Anda mengalami masalah dengan kode promo atau diskon, pastikan Anda memeriksa kembali masa berlaku dan syarat ketentuan dari kode tersebut. Jika masalah masih berlanjut, silakan hubungi tim layanan pelanggan kami untuk bantuan lebih lanjut.</p>
                                </div>
                            </div>
                        </div>
                        <!-- card -->
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-8" aria-expanded="false">
                                Produk pupuk apa saja yang ditawarkan oleh PT. Maulana Raya Abadi?
                            </h6>
                            <div id="faq-item-2-8" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>PT. Maulana Raya Abadi menawarkan berbagai jenis pupuk non-subsidi dari berbagai produsen, termasuk PT. Petrokimia Gresik, PT. Pupuk Kujang, PT. Multi Mas Chemindo, dan lainnya. Produk kami meliputi pupuk Urea, NPK, ZA, KCL, dan berbagai jenis pupuk khusus dengan berbagai kemasan seperti 5 kg, 25 kg, hingga 50 kg.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <h6 class="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-9" aria-expanded="false">
                                Apakah PT. Maulana Raya Abadi menyediakan pupuk organik?
                            </h6>
                            <div id="faq-item-2-9" class="collapse" data-parent="#accordion_2">
                                <div class="card-body">
                                    <p>Ya, kami juga menyediakan pupuk organik seperti Petroganik dari PT. Petrokimia Gresik dan Organik Javagreen dari PT. Permata Agro Persada, dengan berbagai ukuran kemasan untuk mendukung kebutuhan pertanian Anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="need-support text-center mt-100">
                        <h2>Masih butuh bantuan? Tanya Mumu Yuk</h2>
                        <div class="btn-wrapper mb-30">
                            <a href="javascript:void(0);" class="theme-btn-1 btn" onclick="launchTawk()">Tanya Mumu</a>
                        </div>
                        <h3><i class="fas fa-phone"></i> 0852-3176-1006</h3>
                    </div>
                    ...
                    <script type="text/javascript">
                        function launchTawk() {
                            ...
                            (function() {
                                ...
                                s1.async = true;
                                s1.src = 'https://embed.tawk.to/66dbafee50c10f7a00a50bef/1i752efn7';
                                s1.charset = 'UTF-8';
