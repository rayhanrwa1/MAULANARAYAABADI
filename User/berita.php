                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Berita</h1>
                        </div>
    ...
    <div class="ltn__blog-area ltn__blog-item-3-normal mb-120">
        <div class="container">
            <div class="row">
                ...
                $sql = "SELECT entry_id, headline, publication_date, content_summary, image_path FROM tbl_media_announcements";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $imagePath = "../Admin/" . $relativePathFromSQL;
                        $headline = $row['headline'];
                        $publicationDate = date('F j, Y', strtotime($row['publication_date'])); // Format date if needed
                        ?>
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="ltn__blog-item ltn__blog-item-3">
                                <div class="ltn__blog-img">
                                    <a href="berita_detail.php?entry_id=<?php echo $entry_id; ?>"><img src="<?php echo $imagePath; ?>" alt="#"></a>
                                </div>
                                <div class="ltn__blog-brief">
                                    <div class="ltn__blog-meta">
                                        <ul>
                                            <li class="ltn__blog-author">
                                                <a href="#"><i class="far fa-user"></i>PT Maulana Raya Abadi</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <h3 class="ltn__blog-title">
                                        <a href="berita_detail.php?entry_id=<?php echo $entry_id; ?>"><?php echo $headline; ?></a>
                                    </h3>
                                    <div class="ltn__blog-meta-btn">
                                        <div class="ltn__blog-meta">
                                            <ul>
                                                <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i><?php echo $publicationDate; ?></li>
                                            </ul>
                                        </div>
                                        <div class="ltn__blog-btn">
                                            <a href="berita_detail.php?entry_id=<?php echo $entry_id; ?>">Lihat Selengkapnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    echo '<div class="col-12 text-center">Tidak ada berita ditemukan.</div>';
                }
                $conn->close();
                ?>
            </div>
