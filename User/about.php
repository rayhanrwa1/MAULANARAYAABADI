...
<div class="body-wrapper">
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-60 bg-image" data-bg="img/background/br_pt.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Tentang Perusahaan</h1>
                        </div>
    ...
    <!-- ABOUT US AREA START -->
    <div class="ltn__about-us-area pt-120--- pb-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="img/background/logo_pt.jpg" alt="About Us Image">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title">Tentang <br class="d-none d-md-block">  Perusahaan Kami</h1>
                        </div>
                        <p class="mb-20"><strong>PT Maulana Raya Abadi </strong> adalah perusahaan swasta nasional berbentuk Perseroan Terbatas (PT). Anggaran Dasar pendirian perusahaan ini disusun oleh Kayun Widiharsono, SH., M.Kn., seorang Notaris di Kabupaten Trenggalek, sebagaimana tercantum dalam Akta Nomor 02 tanggal 02 Mei 2018.</p>
                        <p class="mb-20">Pendirian ini telah disahkan oleh <strong>Menteri Hukum dan Hak Asasi Manusia Republik Indonesia </strong> (Menkumham RI) dengan nomor pengesahan<strong> AHU-0023631.AH.01.01.TAHUN 2018</strong> pada tanggal 04 Mei 2018.</p>
                        <p>Anggaran Dasar perusahaan tersebut mengalami perubahan yang terakhir kali tercatat dalam <strong>Akta Pernyataan Keputusan Rapat </strong>, Akta Nomor 12 tanggal 07 November 2020, juga disusun oleh Kayun Widiharsono, SH., M.Kn., Notaris di Kabupaten Trenggalek. Perubahan ini telah mendapat pengesahan dari Kemenkumham RI, yang dilaporkan dalam<strong> Perubahan Data Perusahaan Nomor AHU-0075840.AH.01.02.TAHUN 2020.</strong></p>
                    </div>
                </div>
            </div>
        </div>
