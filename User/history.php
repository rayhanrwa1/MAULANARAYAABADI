...
<div class="body-wrapper">
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-70 bg-image" data-bg="img/background/br_history.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Sejarah</h1>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__our-history-inner">
                        <div class="ltn__tab-menu text-uppercase">
                            <div class="nav">
                                <a data-bs-toggle="tab" href="#liton_tab_2_1">2008</a>
                                <a class="active show" data-bs-toggle="tab" href="#liton_tab_2_2">2013</a>
                                <a data-bs-toggle="tab" href="#liton_tab_2_3">2018</a>
                                <a data-bs-toggle="tab" href="#liton_tab_2_4">2024</a>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="img/background/sejarah_2008.jpg" alt="Image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-info-wrap">
                                                <div class="section-title-area ltn__section-title-2">
                                                    <h1 class="section-title">Awal Pendirian CV. Tani Tentrem<span>.</span></h1>
                                                    <p>Didirikan sebagai CV. Tani Tentrem di Kabupaten Trenggalek, perusahaan ini mulai bergerak sebagai distributor pupuk subsidi dari PT. Petrokimia Gresik.</p>
                                                </div>
                                                <p>Fokus pada Distribusi Pupuk Subsidi, melayani kebutuhan pupuk di wilayah Kabupaten Trenggalek.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade active show" id="liton_tab_2_2">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="img/background/sejarah_2013.jpg" alt="Image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-info-wrap">
                                                <div class="section-title-area ltn__section-title-2">
                                                    <h1 class="section-title">Ekspansi Produk<span>.</span></h1>
                                                    <p>Ekspansi ke Pupuk Non Subsidi, memulai pemasaran pupuk non subsidi sebagai langkah untuk memperluas portofolio produk dan jaringan pasar.</p>
                                                </div>
                                                <p>Pengembangan Jaringan Pemasaran di dalam dan di luar wilayah Trenggalek, menandai langkah awal dalam menggarap pasar yang lebih luas.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="liton_tab_2_3">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="img/background/sejarah_2018.jpg" alt="Image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-info-wrap">
                                                <div class="section-title-area ltn__section-title-2">
                                                    <h1 class="section-title">Pembentukan PT. Maulana Raya Abadi<span>.</span></h1>
                                                    <p>Didirikan untuk mengelola dan memfokuskan bisnis pada distribusi pupuk non subsidi, sementara CV. Tani Tentrem tetap fokus pada pupuk subsidi.</p>
                                                </div>
                                                <p>Menjadi Distributor Eksekutif, Retail Manajemen, dan Agrosolution untuk PT. Petrokimia Gresik, serta distributor untuk PT. Pupuk Kujang Cikampek dan beberapa perusahaan pupuk impor.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="liton_tab_2_4">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="img/background/sejarah_2024.jpg" alt="Image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-info-wrap">
                                                <div class="section-title-area ltn__section-title-2">
                                                    <h1 class="section-title">Peran<span>.</span></h1>
                                                    <p>PT. Maulana Raya Abadi menjadi salah satu pemain utama dalam distribusi pupuk non subsidi di Indonesia.</p>
                                                </div>
                                                <p>CV. Tani Tentrem Melanjutkan Distribusi Pupuk Subsidi dan Tetap berperan penting dalam mendukung distribusi pupuk subsidi di berbagai wilayah.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
