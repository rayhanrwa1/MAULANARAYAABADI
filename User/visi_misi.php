...
<div class="body-wrapper">
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-overlay-theme-black-60 bg-image" data-bg="img/background/br_visimisi.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color">Visi Misi</h1>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title">Visi Misi<span>.</span></h1>
                        </div>
                        <div class="about-us-info-wrap-inner about-us-info-devide">
                            <p><strong>Visi :</strong> Menjadi Distributor pupuk Non Subsidi yang berdaya saing tinggi dengan kualitas produk yang terjamin dan berkualitas terbaik.</p>
                            <div class="list-item-with-icon">
                                <p><strong>Misi :</strong></p>
                                <ul class="mission-list">
                                    <li>Mendukung penyaluran pupuk Non Subsidi demi tercapainya program swasembada pangan;</li>
                                    <li>Meningkatkan kualitas usaha untuk menunjang kelancaran kegiatan operasional dan pengembangan usaha Perusahaan;</li>
                                    <li>Memiliki Kredibilitas dalam Menyediakan produk dengan kualitas terbaik;</li>
