...
$query_total = "SELECT COUNT(*) AS total FROM tbl_pdk_893kk WHERE product_type = 'Pupuk'";
...
$query_pagination = "SELECT * FROM tbl_pdk_893kk WHERE product_type = 'Pupuk' LIMIT $start, $limit";
